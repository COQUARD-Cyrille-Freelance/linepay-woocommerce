 ...
 */
function linepay_woocommerce_has_constant( $constant_name ) {
 ...
 * @return mixed
 */
function linepay_woocommerce_get_constant( $constant_name, $default = null ) {
    if ( ! linepay_woocommerce_has_constant( $constant_name ) ) {
        return $default;
    }
