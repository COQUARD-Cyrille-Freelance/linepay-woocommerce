...
namespace Mitango\LinepayWoocommerce\Dependencies\Monolog\Handler;

use Mitango\LinepayWoocommerce\Dependencies\Monolog\Formatter\LineFormatter;
use Mitango\LinepayWoocommerce\Dependencies\Monolog\Formatter\FormatterInterface;
use Mitango\LinepayWoocommerce\Dependencies\Monolog\Logger;
use Mitango\LinepayWoocommerce\Dependencies\Monolog\Utils;
use PhpConsole\Connector;
use PhpConsole\Handler as VendorPhpConsoleHandler;
use PhpConsole\Helper;

/**
 * Mitango\LinepayWoocommerce\Dependencies\Monolog handler for Google Chrome extension "PHP Console"
 *
 ...
 *
 *      $logger = new \Mitango\LinepayWoocommerce\Dependencies\Monolog\Logger('all', array(new \Mitango\LinepayWoocommerce\Dependencies\Monolog\Handler\PHPConsoleHandler()));
 *      \Mitango\LinepayWoocommerce\Dependencies\Monolog\ErrorHandler::register($logger);
 *      echo $undefinedVar;
 ...
 *
 * @phpstan-import-type Record from \Mitango\LinepayWoocommerce\Dependencies\Monolog\Logger
 * @deprecated Since 2.8.0 and 3.2.0, PHPConsole is abandoned and thus we will drop this handler in Mitango\LinepayWoocommerce\Dependencies\Monolog 4
 */
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    private $options = [
        ...
        'classesPartialsTraceIgnore' => ['Mitango\LinepayWoocommerce\Dependencies\Monolog\\'], // array Hide calls of classes started with...
    ...
    /**
     * @param  array<string, mixed> $options   See \Mitango\LinepayWoocommerce\Dependencies\Monolog\Handler\PHPConsoleHandler::$options for more details
