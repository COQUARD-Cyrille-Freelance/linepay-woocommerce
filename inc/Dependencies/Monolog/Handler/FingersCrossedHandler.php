...
use Mitango\LinepayWoocommerce\Dependencies\Monolog\Handler\FingersCrossed\ErrorLevelActivationStrategy;
use Mitango\LinepayWoocommerce\Dependencies\Monolog\Handler\FingersCrossed\ActivationStrategyInterface;
use Mitango\LinepayWoocommerce\Dependencies\Monolog\Logger;
use Mitango\LinepayWoocommerce\Dependencies\Monolog\ResettableInterface;
 ...
 * Mitango\LinepayWoocommerce\Dependencies\Monolog\Handler\FingersCrossed\ namespace.
 *
...
class FingersCrossedHandler extends Handler implements ProcessableHandlerInterface, ResettableInterface, FormattableHandlerInterface
{
    ...
    public function __construct($handler, $activationStrategy = null, int $bufferSize = 0, bool $bubble = true, bool $stopBuffering = true, $passthruLevel = null)
    {
        ...
        if (!$this->handler instanceof HandlerInterface && !is_callable($this->handler)) {
            throw new \RuntimeException("The given handler (".json_encode($this->handler).") is not a callable nor a Mitango\LinepayWoocommerce\Dependencies\Monolog\Handler\HandlerInterface object");
        }
    }
