...
namespace Mitango\LinepayWoocommerce\Dependencies\Monolog;

use DateTimeZone;
use Mitango\LinepayWoocommerce\Dependencies\Monolog\Handler\HandlerInterface;
use Mitango\LinepayWoocommerce\Dependencies\Psr\Log\LoggerInterface;
use Mitango\LinepayWoocommerce\Dependencies\Psr\Log\InvalidArgumentException;
use Mitango\LinepayWoocommerce\Dependencies\Psr\Log\LogLevel;
use Throwable;
use Stringable;

/**
 * Mitango\LinepayWoocommerce\Dependencies\Monolog log channel
 *
...
class Logger implements LoggerInterface, ResettableInterface
{
    ...
    /**
     * Mitango\LinepayWoocommerce\Dependencies\Monolog API version
     *
    ...
    /**
     * Mapping between levels numbers defined in RFC 5424 and Mitango\LinepayWoocommerce\Dependencies\Monolog ones
     *
     ...
     * there is no performance penalty and Mitango\LinepayWoocommerce\Dependencies\Monolog 2 enabled microseconds
     ...
     * Adds a log record.
     *
     * @param  int               $level    The logging level (a Mitango\LinepayWoocommerce\Dependencies\Monolog or RFC 5424 level)
     ...
     *
     * @throws \Mitango\LinepayWoocommerce\Dependencies\Psr\Log\InvalidArgumentException If level is not defined
     *
     * @phpstan-param  Level     $level
    ...
    /**
     * Converts PSR-3 levels to Mitango\LinepayWoocommerce\Dependencies\Monolog ones if necessary
     *
